...
void doTheKernelLaunch(cl_device_id dev, float a, float* h_X, float* h_Y,
	size_t arraySize, float* h_Z)
{
	// --------------------------------------------------
	...
	size_t datasize = arraySize * sizeof(float);
...
float* do_saxpy(cl_device_id curDevice, size_t arraySize)
{
	float a = 2.0;
